...
exports.dispatchWriteJob = function (data) {
	return createJob("database_writer", data, "low", true);
}
...
exports.dispatchCrawlJob = function (data) {
	...
	if (namespace == "spotify:album_id,track_name,album_name") {
		return createJob("mb_release_by_sp_artist_album", data.data, "high", true, 2, 500);
	}

	if (namespace == "musicbrainz:release_id") {
		return createJob("mb_release_by_mb_release_id", data.data, "high", true, 2, 500);	
	}
}
