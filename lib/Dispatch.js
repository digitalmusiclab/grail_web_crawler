...
exports.dispatchWriteJob = function (data) {
	return createJob("database_writer", data, true);
}
...
exports.dispatchCrawlJob = function (data) {
	...
	if (namespace == "isrc") {
		var params = {isrc: id};
		return createJob("spotify_track_by_isrc", params, false);
	}

	if (namespace == "spotify:track") {
		var params = {spotify_track_id: id};
		return createJob("echonest_track_by_spotify_track", params, false);
	}
...
*/
var createJob = function (name, data, removeOnComplete) {
